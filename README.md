...
~~Note: Also the code has around a 3-11% error rate, but it's not that significant. Like for example, sometimes it might give you 3 journeys instead of 2, but you can either leave it as that or figure out a way to make it a journey less.~~ **FIXED**
...
<img width="67%" height="auto" alt="connect routes" src="https://i.imgur.com/BnuZ1eP.png">

## Format for Metro routes
<img width="67%" height="auto" alt="connect routes" src="https://i.imgur.com/53bkVtX.png">

## Format for Express routes
<img width="67%" height="auto" alt="express routes" src="https://i.imgur.com/T4kOd5G.png">

## Format for Waterline routes
<img width="67%" height="auto" alt="express routes" src="https://i.imgur.com/HZB0F7s.png">

## Format for Airlink routes
<img width="67%" height="auto" alt="express routes" src="https://i.imgur.com/yOHb3aH.png">
